...
- **Task 2 — Landing Page:** [`/Task-2/index.html`](./Task-2/index.html)
  Single self-contained HTML file (HTML + CSS + vanilla JS, no frameworks). Live version: **[add your GitHub Pages link here]**
  PageSpeed Insights (Mobile) screenshot: **[add screenshot / link here]**
